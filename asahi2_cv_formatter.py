...
def apply_professional_css():
    ...
    /* Professional header - clean and elegant */
    .professional-header {
    ...
    /* Single professional button style */
    .stButton > button {
        background: #2563eb;
        color: white;
        border: none;
    ...
    /* Remove download button styling - make it look like text */
    ...
    /* Status messages - clean and simple */
    .status-success {
        background: #f0fdf4;
